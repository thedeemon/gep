...
namespace gep
{
    ...
    class HIConnect : HistoryItem
    {
        ...
        public HIConnect(string _filter1, string _pin1, string _filter2, string _pin2, Guid type)
        {
            ...
            majortype = "&MEDIATYPE_" + DsToString.MediaTypeToString(type);
        }
    ...
    class History
    {
        ...
        public void SortConnections()
        {
            ...
            while (i < history.Count - 1) 
            {
                ...
                if (k < 0) i++; //no moves dones, go next                    
            }
        }
    ...
    class CodeGenCPP : CodeGenBase
    {
        ...
        {
            //HistoryItem h1 = history.FindByID(hi.filterid1);
            //HistoryItem h2 = history.FindByID(hi.filterid2);
            ...
            sb.AppendLine("    hr = pBuilder->RenderStream(NULL, " + hi.majortype + ", " + var1 + ", NULL, " + var2 + ");");
        ...
        Dictionary<string, string> known = new Dictionary<string, string>(); // guid = >CLSID_Shit
